...
public class Robot extends TimedRobot {
  ...
  private SendableChooser <AutoModes> autoChooser; 
  ...
  public void robotInit() {
    ...
    autoChooser.addOption("Auto Balance", AutoModes.AUTO_BALANCE);
  ...
  public void autonomousInit() {
    selectedAutoMode = autoChooser.getSelected();
    m_autonomousCommand = m_robotContainer.getAutonomousCommand(selectedAutoMode);
